...
const GiftCard = ({gift}: {gift: Gift}) => {
    ...
    return (
        <div
            className="gift-card group relative rounded-2xl overflow-hidden m-2 transition-transform duration-300 hover:scale-105 hover:z-10"
            onMouseEnter={expand}
            onMouseLeave={collapse}
        >
            <img className="w-full object-cover aspect-square" src={gift.image_url ?? undefined} alt={gift.title} />
<div
    ref={overlayRef}
